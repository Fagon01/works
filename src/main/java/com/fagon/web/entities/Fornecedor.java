...
public class Fornecedor implements Serializable {
	...
	public Fornecedor(Long id, Integer tipo, String cpfOuCnpj, String razaoSocialOuNome, String indicadorDePresenca,
			String inscEstadual, String suframa, String cep, String logradouro, Integer numero, String bairro,
			String complemento, String municipio, String ufEnd, String email, String contatoEmail, String telefone,
			String contato) {
		super();
		this.id = id;
		this.tipo = tipo;
