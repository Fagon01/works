...
public class Transportadora implements Serializable {
	...
	public Transportadora(Long id, Integer tipo, String cpfOuCnpj, String razaoSocialOuNome,
			String inscEstadual, String cep, String logradouro, Integer numero, String bairro,
			String complemento, String municipio, String ufEnd, String email, String contatoEmail, String telefone,
			String contato, Boolean isentoIcms) {
		super();
		this.id = id;
		this.tipo = tipo;
